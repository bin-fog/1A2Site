...
export default function Completed() {
  return (
    <section className="text-gray-600 body-font">
      <div className="max-w-5xl pt-242 pb-24 mx-auto">
      ...
      <h2 className="mt-12 mb-5 text-2xl font-semibold tracking-tighter text-center text-gray-200 lg:text-7xl md:text-6xl">
        Тестирование пройдено
      </h2>
      <br></br>
      <p className="mx-auto text-xl text-center text-gray-300 font-normal leading-relaxed fs521 lg:w-2/3">
        Мы проанализировали результаты вашей заявки и на их основе можем порекомендовать вам следующие мероприятия:
      </p>
      ...
      <p className="mx-auto text-xl text-center mb-12 text-gray-300 font-normal leading-relaxed fs521 pt-10 lg:w-2/3">
        Вы больше всего подходите под следующие направления:
      </p>
